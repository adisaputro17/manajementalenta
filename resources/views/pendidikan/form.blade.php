<div class="mb-3">
    ...
    <select name="pegawai_id" class="form-control">
        ...
        <option value="{{$p->id}}" @if(isset($pendidikan) && $pendidikan->pegawai_id==$p->id) selected @endif >
            {{$p->nama}}
        </option>
        @endforeach
    </select>
...
<div class="mb-3">
    ...
    <select name="tingkatan" class="form-select">
        ...
        <option value="{{$key}}" @if(isset($pendidikan) && $pendidikan->tingkatan==$key) selected @endif>
            {{$key}}
        </option>
...
<div class="mb-3">
    ...
    <input type="text" name="universitas_sekolah" class="form-control" value="{{old('universitas_sekolah',$pendidikan->universitas_sekolah ?? '')}}">
</div>
